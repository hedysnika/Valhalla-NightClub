...
export function Footer() {
  return (
    <footer className="w-full text-white bg-black">
      ...
      <div><Icon icon="ic:baseline-facebook" width="25" height="25" /></div>
      <div><Icon icon="mdi:facebook-messenger"  width="25" height="25" /></div>
      <div><Icon icon="mdi:instagram" width="25" height="25" /></div>
      <div><Icon icon="iconoir:tiktok" width="25" height="25" /></div>
